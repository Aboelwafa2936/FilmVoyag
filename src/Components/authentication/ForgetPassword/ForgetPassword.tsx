...
export default function ForgetPassword() {
  ...
  return (
    ...
    <section className=' min-h-screen flex items-center bg-[#111827] justify-center'>
    <div className="w-full md:w-1/2 lg:w-1/3 mx-auto px-8 py-10 flex flex-col items-center mt-5">
      <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4">
        ...
        <button type="submit" className="bg-[#6028ff] text-white font-medium py-2 px-4 rounded-md shadow-sm disabled:bg-gray-500" disabled={isLoading}>Submit{isLoading && <i className='fa-solid fa-spinner fa-spin'></i>}</button>
